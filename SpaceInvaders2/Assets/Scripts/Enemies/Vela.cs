...
public class Vela : Enemy
{
    public GameObject laserPoint;
    public GameObject velaLaser;
    ...
    private void CheckShootLaser()
    {
        ...
        if (currentLaserTimer >= laserTimer)
        {
            ...
            GameObject laser = Instantiate(velaLaser, laserPoint.transform.position, Quaternion.Euler(90.0f, 0.0f, 0.0f));
